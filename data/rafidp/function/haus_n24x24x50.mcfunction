...
execute positioned ~ ~29 ~ run function rafidp:etage24x24_a
execute positioned ~ ~34 ~ run function rafidp:etage24x24_b
execute positioned ~ ~39 ~ run function rafidp:etage24x24_a
execute positioned ~ ~44 ~ run function rafidp:etage24x24_b
execute positioned ~ ~49 ~ run function rafidp:dach24x24
